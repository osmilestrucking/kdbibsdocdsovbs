...
import * as sty from "./PlasmicListItem.module.css"; // plasmic-import: CEvMXq3EASX2/css

import CheckCircleIcon from "./icons/PlasmicIcon__CheckCircle"; // plasmic-import: rfjNWy-PmaxY/icon
  ...
  return (
    ...
    >
      ...
      {p.renderPlasmicSlot({
        defaultContents: (
          <CheckCircleIcon
            className={classNames(defaultcss.all, sty.svg__uoycd)}
            role={"img"}
          />
        ),
